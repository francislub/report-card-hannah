...
class Markss:
    def __init__(self,root,selected_class="Select Class"):
        ...
        btn_subject = Button(LeftMenu,text="Month For\n Tests",command=self.show_loading_month,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",17,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_subject = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",17,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_subject = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",17,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_subject = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",17,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_subject = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",17,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_subject = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",17,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_terminalRe = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",17,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_ObroadSheet = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",18,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_AbroadSheet = Button(LeftMenu,text="",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",18,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        ...
        btn_exit = Button(LeftMenu,text="Close",command=self.logout,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",18,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
    ...
    def update_selected_class_label(self, event):
        ...
        cursor = self.conn.cursor()
        cursor.execute("SELECT subject1, subject2, subject3, subject4, subject5, subject6, subject7, subject8 FROM subject WHERE class = %s", (selected_class,))
    ...
    #########################################  
    #########################################  
    def show_loading_month(self):
        self.loading_label = Label(self.root, text="Loading...", font=("times new roman", 20, "bold"))
        self.loading_label.pack()
        self.root.after(1000, self.month_details)  # After 30 seconds, show another window
        
    def month_details(self):
        self.loading_label.destroy()
        self.new_window=Toplevel(self.root)
        self.app=Month(self.new_window)
    #########################################  
         # Create the UI components
       
    def logout(self):
        logout = tkinter.messagebox.askyesno("Report Management System", "Confirm if you want to Close", parent=self.root)
        if logout:
