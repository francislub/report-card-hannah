...
class Cuser:
    def __init__(self,root):
        ...
        #===================labelframe====================================================
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Add New User",font=("times new roman",18,"bold"),padx=2)
        ...
        btnExit=Button(btn_frame,text="Close",command=self.Exit,font=("arial",11,"bold"),bg="black",fg="gold",width=12)
