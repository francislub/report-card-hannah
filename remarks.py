...
class remark:
    def __init__(self,root):
        ...
        self.var_requirements = StringVar()
        ...
        #=====================title=======================================================
        lbl_title=Label(self.root,text="REPORT REMARK'S FOR PRIMARY SCHOOL",font=("times new roman",18,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
        ...
        labelframeleft.place(x=10,y=50,width=755,height=120)
        #====================labels and entrys==================================================================================
        #===========================================================================================================================
        ...
        btn_frame.place(x=400,y=10,width=280,height=80)
        ...
        #==========================Requirements==================
        lblreq=Label(self.root,text="Requirements",font=("times new roman",18,"bold"),padx=40,pady=30)
        lblreq.place(x=780,y=75,width=150,height=60)
        # Create a Text widget
        self.txtreq = Entry(self.root ,textvariable= self.var_requirements, width=29, font=("times new roman", 15))
        self.txtreq.place(x=970,y=55,width=380,height=200)
        ...
        lblfee=Label(data_frame,text="Fees",font=("times new roman",18,"bold"),padx=40,pady=30)
        lblfee.grid(row=0,column=2)
        txtfee=Entry(data_frame,textvariable=self.var_fee,width=23,font=("times new roman",15,"bold"))
        txtfee.grid(row=0,column=3)
        
        lblbegin=Label(data_frame,text="Next Term Begins: Day",font=("times new roman",18,"bold"),padx=40,pady=30)
        lblbegin.grid(row=1,column=0)
        txtbegin = Entry(data_frame,textvariable=self.var_termbegins, width=25, font=("times new roman", 15, "bold"))
        txtbegin.grid(row=1, column=1)
        
        lblend=Label(data_frame,text="Next Term Begins: Boarder",font=("times new roman",18,"bold"),padx=40,pady=30)
        lblend.grid(row=1,column=2)
        txtend=Entry(data_frame,textvariable=self.var_termends,width=23,font=("times new roman",15,"bold"))
        ...
        entry_comm2_1=ttk.Entry(data_frame,textvariable=self.var_hcomm1,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_2=ttk.Entry(data_frame,textvariable=self.var_hcomm2,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_3=ttk.Entry(data_frame,textvariable=self.var_hcomm3,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_4=ttk.Entry(data_frame,textvariable=self.var_hcomm4,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_5=ttk.Entry(data_frame,textvariable=self.var_hcomm5,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_6=ttk.Entry(data_frame,textvariable=self.var_hcomm6,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_7=ttk.Entry(data_frame,textvariable=self.var_hcomm7,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_8=ttk.Entry(data_frame,textvariable=self.var_hcomm8,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_9=ttk.Entry(data_frame,textvariable=self.var_hcomm9,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        entry_comm2_10=ttk.Entry(data_frame,textvariable=self.var_hcomm10,width=36,font=("times new roman",13,"bold"),state="readonly")
        ...
        if self.var_class.get() == "Select":
            ...
            #try:
                ...
                if existing_record:
                    ...
                    my_cursor.execute("""
                    UPDATE remarks
                    SET fee =%s, termbegins=%s, termends=%s,
                        ...
                        mark1_10=%s, mark2_10=%s, tcomm10=%s, hcomm10=%s, requirements =%s
                    WHERE  class=%s
                    """, (self.var_fee.get(),
                    ...
                    """, (self.var_gradeID.get(), selected_class, 
                        ...
                        self.var_mark2_10.get(),
                        self.var_tcomm10.get(),
                        self.var_hcomm10.get(), self.var_requirements.get(),))
        ...
        if selected_class != "":
            try:
                ...
                if rows:
                    ...
                    self.var_fee.set(row[2])
                    self.var_termbegins.set(row[3])
                    self.var_termends.set(row[4])
                    self.var_mark1_1.set(row[5])
                    self.var_mark2_1.set(row[6])
                    self.var_tcomm1.set(row[7])
                    self.var_hcomm1.set(row[8])
                    self.var_mark1_2.set(row[9])
                    self.var_mark2_2.set(row[10])
                    self.var_tcomm2.set(row[11])
                    self.var_hcomm2.set(row[12])
                    self.var_mark1_3.set(row[13])
                    self.var_mark2_3.set(row[14])
                    self.var_tcomm3.set(row[15])
                    self.var_hcomm3.set(row[16])
                    self.var_mark1_4.set(row[17])
                    self.var_mark2_4.set(row[18])
                    self.var_tcomm4.set(row[19])
                    self.var_hcomm4.set(row[20])
                    self.var_mark1_5.set(row[21])
                    self.var_mark2_5.set(row[22])
                    self.var_tcomm5.set(row[23])
                    self.var_hcomm5.set(row[24])
                    self.var_mark1_6.set(row[25])
                    self.var_mark2_6.set(row[26])
                    self.var_tcomm6.set(row[27])
                    self.var_hcomm6.set(row[28])
                    self.var_mark1_7.set(row[29])
                    self.var_mark2_7.set(row[30])
                    self.var_tcomm7.set(row[31])
                    self.var_hcomm7.set(row[32])
                    self.var_mark1_8.set(row[33])
                    self.var_mark2_8.set(row[34])
                    self.var_tcomm8.set(row[35])
                    self.var_hcomm8.set(row[36])
                    self.var_mark1_9.set(row[37])
                    self.var_mark2_9.set(row[38])
                    self.var_tcomm9.set(row[39])
                    self.var_hcomm9.set(row[40])
                    self.var_mark1_10.set(row[41])
                    self.var_mark2_10.set(row[42])
                    self.var_tcomm10.set(row[43])
                    self.var_hcomm10.set(row[44])
                    self.var_requirements.set(row[45])
