...
class Student:
    def __init__(self,root):
        ...
        lblimage.grid(row=9,column=0,sticky=W)
        ...
        lbl_show_pic = Label(labelframeleft)
        ...
        #f=Frame(labelframeleft,bd=3,bg="white",width=200,height=100, relief=GROOVE)
        #f.place(x=170, y=320)
        #lblimage = Label(f, bg="blue")
        #lblimage.place(x=0, y=0) 
        #txtimage=ttk.Entry(labelframeleft,textvariable=self.var_image,width=29,font=("times new roman",13,"bold"))
        #txtimage.grid(row=10,column=1)
        #btn_open=Button(labelframeleft,text="Upload Image", command=open_image,font=("times new roman",13,"bold"))
        #btn_open.grid(row=10,column=0,sticky=W)
        
        #lblimage=ttk.Entry(labelframeleft,textvariable=self.var_image,width=29,font=("times new roman",13,"bold"))
        #lblimage.grid(row=9,column=1)
