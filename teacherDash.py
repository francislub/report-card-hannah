...
class Teacher:
    def __init__(self,root):
        ...
        btn_viewStud = Button(LeftMenu,text="View Students",command=self.view,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",16,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_report = Button(LeftMenu,text="Mid  Report",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",16,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_mock = Button(LeftMenu,text="Mock",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",16,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_Attendance = Button(LeftMenu,text="Attendance",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",16,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        btn_Remarks = Button(LeftMenu,text="Remarks",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",16,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
    ...
    #===========Left Menu==============
        ...
        # Load the logo image
        logo_image = Image.open("images/tea.png")  # Replace "path_to_your_logo_image.png" with the actual path to your logo image
    ...
    def view(self):
        self.loading_label = Label(self.root, text="Loading...", font=("times new roman", 20, "bold"))
        self.loading_label.pack()
        self.root.after(1000, self.views)  # After 30 seconds, show another window
        
    def views(self):
        self.loading_label.destroy()
        self.new_window=Toplevel(self.root)
        self.app=View(self.new_window)
